...
const postData = [
  ...
  privacy: false,
          ...
          instagram: 'nan',
          type: 'Reforma/cambio a un Proyecto de Ley',
          body: 'Que el cae siga funciodo tal como ahora, pero sin intereses',
          status: 'pendiente',
          rating: 0,
          createdAt: new Date(),
          updatedAt: new Date(),
  ...
  privacy: true,
          ...
          status:'aprobado',
          type: 'Reforma/cambio a un Proyecto de Ley',
          body: 'Optimizar el trabajo de la cámara de diputados sesiodo remotamente y delegando el trabajo distrital de campo y de comisiones.',
          rating: 0,
          createdAt: new Date(),
          updatedAt: new Date(),
  },
  ...
  privacy: true,
          ...
          status:'aprobado',
          type: 'Reforma/cambio a un Proyecto de Ley',
          body: 'Estatizar la producción y distribución eléctrica, ficiar la inversión estructural con dineros previsionales.',
          rating: 0,
          createdAt: new Date(),
          updatedAt: new Date(),
  },
  ...
  privacy: true,
          ...
          status:'aprobado',
          type: 'Reforma/cambio a un Proyecto de Ley',
          body: 'Todos los nuevos proyectos de infraestructura (puentes, caminos, carreteras, puertos, aeropuertos, túneles, etc) ficiarlos un cuarto el estado, dos cuartos privados y un cuarto AFPs (en representación de nosotros para aumentar nuestra futura pensión)',
          rating: 0,
          createdAt: new Date(),
          updatedAt: new Date(),
  },
  ...
  privacy: true,
          ...
          status:'rechazado',
          type: 'Proyecto ciudadano',
          body: 'Mejorar la salud mental calando en los determites sociales ',
          rating: 0,
          createdAt: new Date(),
          updatedAt: new Date(),
  },
  ...
  privacy: false,
          ...
          instagram: 'nan',
          type: 'Reforma/cambio a un Proyecto de Ley',
          body: 'Sueldo mensual que puede ser equivalente a lo que ga los militares o carabineros para cada deportista seleccionado nacional para que se ficie la carrera y el país logre mas clasificaciones olímpicas ',
          status: 'pendiente',
          rating: 0,
          createdAt: new Date(),
          updatedAt: new Date(),
  ...
  privacy: false,
          ...
          instagram: 'nan',
          type: 'Reforma/cambio a un Proyecto de Ley',
          body: 'Hagamos que los sueldos de cargos públicos no sean fijos, sino que se limiten a mantener la vida de los funcionarios. En otras palabras, que en vez de pagar un sueldo fijo todos los meses, sean los mismos trabajadores que realicen un balance de cuentas de sus gastos (como trabajadores, no como particulares) y que estos sean cubiertos por el gobierno, dejando al mínimo el margen de gacia. Con esto, se devolvería el sentido a la política y los cargos públicos: el servicio y preocupación por los demás, no el lucro personal. ',
          status: 'pendiente',
          rating: 0,
          createdAt: new Date(),
          updatedAt: new Date(),
  ...
  privacy: false,
          ...
          instagram: 'nan',
          type: 'Proyecto ciudadano',
          body: 'Proyecto a clases sociales que no tienen acceso a cultura y educación de calidad a través de workshops para enseñarles de educación civil y las políticas públicas a las que esta asociado nuestro país y cómo funcio. Esto a través de la colaboración de diferentes áreas la cual cada una aportará con su desempeño ej : comerciales, sociologo, abogado, diseñador...',
          status: 'pendiente',
          rating: 0,
          createdAt: new Date(),
          updatedAt: new Date(),
  ...
  privacy: true,
          ...
          status:'aprobado',
          type: 'Proyecto ciudadano',
          body: 'Replantear la educación de raíz.  El sistema de educación actual está obsoleto, sin tener que reinventar la educación se puede simplemente copiar los sistemas de educación de Finlandia o Noruega.   Si queremos ir más lejos debemos crear un sistema educativo integrando el conocimiento existente en psicología, neurociencia y sociología. Preocupándose de 3 pilares fundamentales: Inteligencia, Integridad y Socialización.  Actualmente la educación se &quote&concentra&quote& en su totalidad en la inteligencia fallando rotundamente porque en pocas palabras apela a la motivación extriseca de las personas y no la intriseca, lo que resulta en una baja calidad de experiencia o un aprendizaje lento o nulo.   Las otras dos partes se mencio pero nunca se plantea el como lograrlas, se deben diseñar experiencias (situaciones actuadas) que reflejen la importancia de la honestidad, inclusividad entre otros. Donde los alumnos sean capaces de observar el daño que genera un robo o una mentira por decir un ejemplo.           ',
          rating: 0,
          createdAt: new Date(),
          updatedAt: new Date(),
  },
  ...
  privacy: false,
          ...
          instagram: 'nan',
          type: 'Reforma/cambio a un Proyecto de Ley',
          body: 'Propuesta para mejorar la eduación básica y media en Chile que persiste aúm hasta el actual año 2019:    Crear un proyecto de ley que establezca una educación igualitaria en base a una base de ingresos ficiada de 2 formas: 1) por el estado y sus recursos en el caso de ser un establecimiento público; 2) y por el establecimiento de carácter privado o subvencionado ficiado con un prcentaje directamemte proporcional a los ingresos de los avales que fician la educación de sus representados, en suma por el estado como ficiación complementaria si esque dichas ficiaciones de avales no alcanzan a cubrir los gastos necesarios. Sobre este punto el porcentaje de ficiación de los avales de los establecimientos subvencionados es menor al de los privados.  De esta forma con esta nueva ley se crea una base para proporcionar mejoras en la docencia y materiales pedagógicos, ademas de la posiblidad de mejorar dicha ley con mejoras legislativas de modificación de aquella con medidas que busquen y amparen la mejora de la.educación según los contextos socio-económicos y políticos en los que esta sumergida la educación actual en nuestro país Chile.',
          status: 'pendiente',
          rating: 0,
          createdAt: new Date(),
          updatedAt: new Date(),
  ...
  privacy: false,
          ...
          instagram: 'nan',
          type: 'Proyecto ciudadano',
          body: 'Cambio de modelo. Estado subsidiario. Redistribuir gacias de bienes nacionales e impuestos, en un orden de prioridades según real necesidad del país. Limitar y excluir al privado de acciones que le corresponderían al estado: educación, salud, energía, bienes nacionales, etc. Gasto en las personas. ',
          status: 'pendiente',
          rating: 0,
          createdAt: new Date(),
          updatedAt: new Date(),
  ...
  privacy: false,
          ...
          instagram: 'nan',
          type: 'Reforma/cambio a un Proyecto de Ley',
          body: ',mentar edad de jubilacion de mujeres gradualmente a 65 añosemas reducir su sueldo.ue el estado entregue un prestamo (en UF) a los estudiantes sin intereses para liberar recursos del estado',
          status: 'pendiente',
          rating: 0,
          createdAt: new Date(),
          updatedAt: new Date(),
  ...
  privacy: false,
          ...
          instagram: 'nan',
          type: 'Reforma/cambio a un Proyecto de Ley',
          body: 'Eliminar el pago de contribuciones  a gente de la tercera edad y más adelante a todos. Es un impuesto que no guarda relación con el consumo ni con los ingresos de las personas, a mi parecer muy mal diseñado. ',
          status: 'pendiente',
          rating: 0,
          createdAt: new Date(),
          updatedAt: new Date(),
  ...
  privacy: false,
          ...
          instagram: 'nan',
          type: 'nan',
          body: 'Disminuir el impuesto a empresas que funcionen en base a energías renovables, así se contribuye a disminuir precios, cuidar el medio ambiente y dar incentivos al uso de estas energías. ',
          status: 'pendiente',
          rating: 0,
          createdAt: new Date(),
          updatedAt: new Date(),
  ...
  privacy: false,
          ...
          instagram: 'nan',
          type: 'nan',
          body: 'Recalcular las pensiones ya que están echas pensando en que la gente vive hasta más o menos 110 años y si se reduce, podrán recibir más plata',
          status: 'pendiente',
          rating: 0,
          createdAt: new Date(),
          updatedAt: new Date(),
  ...
  privacy: false,
          ...
          instagram: 'nan',
          type: 'Reforma/cambio a un Proyecto de Ley',
          body: 'Disminuir el impuesto a los combustibles. El uso de combustible está presente prácticamente en cualquier actividad económica y contribuye al encarecimiento de bienes y servicios de todo tipo, afectando el bolsillo de todas las familias. ',
          status: 'pendiente',
          rating: 0,
          createdAt: new Date(),
          updatedAt: new Date(),
  ...
  privacy: false,
          ...
          instagram: 'nan',
          type: 'Proyecto ciudadano',
          body: 'Educación de ecosistemas chilenos a alumnxs de secundaria. Ecología útil para conocer de mejor manera lo que nos rodea',
          status: 'pendiente',
          rating: 0,
          createdAt: new Date(),
          updatedAt: new Date(),
